...
Route::prefix('role-type')->middleware('auth:sanctum')->group(function(){
    Route::post('/', [RoleController::class, 'store'])->name('role-type-store');
    Route::put('/{roleType}', [RoleController::class, 'update'])->name('role-type-update');
    Route::delete('/{roleType}', [RoleController::class, 'distroy'])->name('role-type-delete');
});
Route::prefix('role-type')->group(function(){
    Route::get('/', [RoleController::class, 'index'])->name('role-type-index');
});

Route::prefix('workshop')->middleware('auth:sanctum')->group(function(){
    Route::post('/', [WorkShopController::class, 'store'])->name('workshop-store');
    Route::put('/{workShop}', [WorkShopController::class, 'update'])->name('workshop-update');
    Route::delete('/{workShop}', [WorkShopController::class, 'distroy'])->name('workshop-delete');
});
...
Route::prefix('workshop-reation')->middleware('auth:sanctum')->group(function(){
    Route::post('/', [WorkShopRelationController::class, 'store'])->name('workshop-reation-store');
    Route::put('/{workShop}', [WorkShopRelationController::class, 'update'])->name('workshop-reation-update');
    Route::delete('/{workShop}', [WorkShopRelationController::class, 'distroy'])->name('workshop-reation-delete');
});
Route::prefix('workshop-reation')->group(function(){
    Route::get('/', [WorkShopRelationController::class, 'index'])->name('workshop-reation-index');
});
...
Route::prefix('session')->middleware('guest')->group(function(){
    ...
    Route::delete('/', [SessionController::class, 'distroy'])->name('session-delete');
});